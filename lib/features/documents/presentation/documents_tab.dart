    ...
    return Scaffold(
      ...
      body: docsAsync.when(
        ...
        data: (docs) {
          ...
          final types = {for (final d in docs) d.document.type}.toList()..sort();
          final filtered = docs
              .where((d) => _statusFilter == null || d.computedStatus == _statusFilter)
              .where((d) => _typeFilter == null || d.document.type == _typeFilter)
              .toList();
          return Column(
            children: [
              Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          ChoiceChip(
                            ...
                            selected: _statusFilter == DocumentVersionStatus.valid,
                          ...
                          ChoiceChip(
                            ...
                            selected:
                                _statusFilter == DocumentVersionStatus.expiringSoon,
                            onSelected: (_) => setState(() =>
                                _statusFilter = DocumentVersionStatus.expiringSoon),
                          ),
                          const SizedBox(width: 8),
                          ChoiceChip(
                            ...
                            selected: _statusFilter == DocumentVersionStatus.expired,
                            onSelected: (_) => setState(
                          ...
                          ChoiceChip(
                            ...
                            selected: _statusFilter == DocumentVersionStatus.archived,
                            onSelected: (_) => setState(
